    ...
    <div style={{
      ...
      <div className="glass-card fade-in" style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
               ...
               <Link href="/auth/forgot" style={{ fontSize: '0.75rem', color: '#3b82f6', textDecoration: 'none' }}>Forgot password?</Link>
            </div>
            <div style={{ position: 'relative' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ background: '#fff', borderRadius: '4px', padding: '1px' }}>
        ...
        <div style={{
          ...
          Don't have an account? <Link href="/auth/signup" style={{ color: '#fff', textDecoration: 'none', fontWeight: '500' }}>Create account</Link>
        </div>
      </div>
    </div>
  );
