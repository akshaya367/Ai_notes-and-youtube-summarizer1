  ...
  return (
    <div style={{
      ...
      <aside className="glass" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1rem', background: 'var(--glass-bg)', borderRadius: '0.75rem' }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: '0.75rem', color: '#71717a' }}>Admin</div>
          </div>
          <LogOut size={16} color="#71717a" cursor="pointer" />
        </div>
      </aside>
      ...
      <main style={{ flex: 1, padding: '3rem', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
          <div>
            <h1 style={{ fontSize: '2.25rem', marginBottom: '0.5rem' }}>Welcome back, John</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1.5rem', marginBottom: '3rem' }}>
          ...
          <StatCard icon={<User size={20} color="#8b5cf6" />} label="Satisfied Users" value="98.2%" change="+0.4%" />
        </div>
        ...
        <section className="glass-card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <ActivityItem 
              title="Refund status for order #8492" 
              status="Answered" 
              time="25 mins ago" 
              user="Sarah Jenkins"
            />
            <ActivityItem 
              title="Integration help with Next.js" 
              status="Escalated" 
              time="2 hours ago" 
              user="Mike Ross"
              escalated
            />
            <ActivityItem 
              title="Pricing for Enterprise accounts" 
              status="Answered" 
              time="5 hours ago" 
              user="David Miller"
            />
            <ActivityItem 
              title="Forgot password reset loop" 
              status="Resolved" 
              time="Yesterday" 
              user="Anna Wu"
            />
